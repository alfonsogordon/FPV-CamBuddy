...
function update(){
 ...
 body.innerHTML=`
  ...
  <ol>
   ...
   <li>Power on only that new camera and let FreeCLinker discover, connect and save it.</li>
  ...
  <p>For multiple new GoPros the same one-at-a-time rule applies. A GoPro that has never been paired with FreeCLinker before may also need its <strong>Pair</strong> menu opened for the initial connection.</p>

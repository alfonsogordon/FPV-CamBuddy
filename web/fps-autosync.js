...
$('fpsTopSave').onclick=()=>{if(!connected()||demo()||reading||saving)return;saving=true;refresh();click('applyBtn');setTimeout(()=>click('auxApplyBtn'),120);setTimeout(()=>click('fpsApplyAll'),240)};
}
